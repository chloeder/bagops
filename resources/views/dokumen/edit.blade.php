                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form action="/dokumen/{{ $data->slug }}" method="post" class="form"
                                        ...
                                        <div class="col-md-12 col-12">
                                            <div class="form-group mb-4">
                                                ...
                                                <input type="text" id="judul" class="form-control"
                                                    placeholder="Nama Dokumen" name="judul" value="{{ $data->judul }}"
                                                    required />
                                                @if ($errors->any())
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <input type="text" id="nomor" class="form-control"
                                                    placeholder="Kode Dokumen" name="nomor" value="{{ $data->nomor }}"
                                                    required />
                                                @if ($errors->any())
                                                    @foreach ($errors->all() as $error)
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <textarea class="form-control" id="keterangan" rows="3" name="keterangan" value="{{ $data->keterangan }}"
                                                    required></textarea>
                                                @if ($errors->any())
                                                    @foreach ($errors->all() as $error)
                                                        <div class="text-danger">{{ $error }}</div>
